...
class _ViewUserScreenState extends State<ViewUserScreen> implements ViewUserInterface{
  var isLoading = false;
  ...
  void initState() {
    ...
    setState(() {
      isLoading=true;
      viewUserPresenter.doUserListAPI("",skip,limit);
    });
  }
  void _searchingData(String enteredKeyword,int skip, int limit) {
    userDataList.clear();
    if (enteredKeyword.isEmpty) {
      viewUserPresenter.doUserListAPI("",skip,limit);
    } else {
      viewUserPresenter.doUserListAPI(enteredKeyword,skip,limit);
    }
  }
  int _counter = 1;
  @override
                      ...
                      Container(
                          ...
                          child: Card(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (value) => _searchingData(value,skip,limit),
        ...
        DataCell(GestureDetector(
          onTap: (){
            if(userInfo.status==true) {
              showAlertblockDialog(context,userInfo.id.toString(), status.toString());
            }
          },
          child: Container(
            ...
            Container(
              ...
              child: Wrap(
                children: [
                  ...
                  Center(
                    child:
                    Text("Are you sure want to Deactivate this User?",style: TextStyle(color:Colors.black,fontWeight: FontWeight.w600),),
                  ),
                  Center(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: (){
                              ...
                              viewUserPresenter.doUserBlockAPI(user_id, status);
                              Navigator.pop(context);
                            },
                            child: Container(
                              width: 120,
