...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> implements PolicyInterface{
  var isLoading = false;
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Header(title: "Privacy Policy",type:1),
              ),
              Container(
                          ...
                          TextButton(
                            ...
                            onPressed: () async {
                              ...
                              if(txt.isEmpty){
                                ...
                                policyPresenter.doAddPrivatePolicy(result);
                                print("result::"+result);
                              }
                            },
                            child: Text(
